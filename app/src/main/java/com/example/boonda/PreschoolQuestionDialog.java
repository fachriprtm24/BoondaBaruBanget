...
public class PreschoolQuestionDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View a = inflater.inflate(R.layout.activity_preschool_discussion,null);
        ...
        Topic = a.findViewById(R.id.PreschoolTitle);
        ...
        builder.setView(v)
                ...
                .setPositiveButton("Post", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dbRef = FirebaseDatabase.getInstance().getReference().child("Discussion").child("Preschool");
