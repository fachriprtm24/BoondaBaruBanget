...
public class ToddlersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        dbref = FirebaseDatabase.getInstance().getReference().child("topic").child("toddlers");
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ToddlersActivity.this, "Belum ada pertanyaan", Toast.LENGTH_SHORT).show();
            }
        });
    }
