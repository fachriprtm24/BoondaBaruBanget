...
public class EducationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_education_discussion);
...
//        });
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new AdapterActivity(EducationActivity.this,list, "education");
    ...
    private void openDialog(Integer size){
        ...
        EducationQuestionDialog dlg = EducationQuestionDialog.newInstance(size);
